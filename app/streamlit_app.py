...
Two tabs:
    ...
    - Model Accuracy:  compare each model's saved test accuracy / F1 score,
                        plus the evaluation charts saved by train_model.py
...
def render_accuracy_tab(comparison):
    ...
    st.caption("Generated by train_model.py from weather_forecast_data.csv.")
...
def main():
    ...
    predict_tab, accuracy_tab = st.tabs(["🔮 Predict", "📊 Model Accuracy"])
